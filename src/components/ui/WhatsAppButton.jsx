...
const WhatsAppButton = () => {
  ...
  // Calcular posición bottom según el dispositivo
  const getBottomPosition = () => {
    if (isMobile) {
      return '80px'; // 80px del fondo (encima de la barra de navegación móvil)
    }
    return '24px'; // posición normal en PC
  };
  ...
  return (
    ...
    >
      ...
      {/* Texto flotante - Oculto en móviles para no ocupar espacio */}
      {isHovered && !isMobile && (
